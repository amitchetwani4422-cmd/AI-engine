...
const CHARACTERS = [
  {
    ...
    referencePrompt: "Photorealistic full-body portrait, real Indian male actor age 28 as Ram, deep indigo-blue complexion like polished lapis lazuli — matte skin texture not glowing, sharp noble Kshatriya jaw and serene dark eyes, golden tilak on forehead, handcrafted jewelled peacock-feather gold mukut crown, heavy hand-embroidered gold silk dhoti with wide real zari border, sacred white janeu thread across bare muscular chest, holding a carved golden longbow, bare feet on white marble, ancient North Indian Nagara sandstone palace colonnade with warm afternoon golden light shafts, ARRI Alexa cinema camera, natural warm volumetric light, shallow depth of field with face sharp, real skin pores and muscle definition visible, genuine gold jewelry with metal reflections, real silk fabric sheen, no CGI glow no illustration no painting no animation no cartoon",
  ...
  },
  {
    ...
    referencePrompt: "Photorealistic VFX creature portrait, hyper-realistic saffron-orange vanara deity, Hollywood blockbuster photoreal CGI quality like Planet of the Apes, authentic primate anatomy: protruding simian muzzle, flat wide nose, heavy brow ridge, round primate skull, warm saffron-orange fur with individual hair strands visible, large expressive dark devotional eyes looking upward, powerfully muscular upright standing body, long thick monkey tail behind with small orange flame at the very tip only — no fire on head or body, heavy golden cylindrical mace gripped firmly in right hand, sacred white janeu thread across broad chest, plain white cotton dhoti, gold bangles on wrists, standing in ancient stone temple hall with warm natural oil-lamp amber light and carved stone pillars, natural warm torch-amber light, individual fur texture visible, genuine gold mace reflection, no neon aura no glowing body no cartoon no anime, tall imposing figure not small",
    preferredModel: "kling-3.0",
    universeId: "A",
  },
  {
