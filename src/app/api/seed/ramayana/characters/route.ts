...
const CHARACTERS = [
  {
    ...
    visualReferences: [
      "blue-luminescent divine skin radiating Vishnu's celestial light""sharp noble Kshatriya features, long dark eyes filled with divine calm""sacred janeu (yajnopavita) thread across bare chest""golden tilak on forehead, divine tej (radiance) surrounding face and body""Kodanda — golden divine bow held with perfect archer's grace""quiver of luminous divine arrows on back",
    ],
    clothingRules:
    ...
    restrictedChanges: [
      "skin tone always blue-luminescent — never dark brown or fair""always barefoot — no footwear ever""janeu thread always visible across chest""always carries bow — even in non-combat scenes",
    ],
    samplePoses: [
      "standing in divine archer stance — bow drawn, eyes focused""seated in padmasana in forest — meditative calm""right hand in abhaya mudra — blessing devotees""walking in forest with Sita on left, Lakshman behind",
    ],
    referencePrompt: "Lord Ram avatar of Vishnu, full body portrait, blue-luminescent celestial skin glowing with divine Vishnu light, noble sharp Kshatriya face with golden tilak and long dark calm eyes, jewelled peacock-feather mukut crown, golden silk dhoti with intricate zari border, sacred janeu thread across bare muscular chest, golden Kodanda divine bow held gracefully, quiver of divine arrows on back, bare consecrated feet, divine golden aura halo, ancient Nagara temple pillars background with warm saffron god rays, cinematic 8K ultra-detailed, no modern elements, no western clothing, no anime, no cartoon",
  ...
  },
  {
    ...
    visualReferences: [
      "golden-wheat complexion radiant as Goddess Lakshmi — luminous warm glow""large gentle eyes, soft serene expression, compassionate divine grace""dark hair in single braid adorned with jasmine flowers and gold ornaments""delicate divine hands, slender graceful form""maang tikka (forehead ornament), gold necklace, bangles, earrings",
    ],
    clothingRules:
  ...
  },
  {
    ...
    visualReferences: [
      "powerful saffron-tinted divine simian form — muscular vajra-hard body""long tail with divine orange flame at tip curling upward""broad chest bearing Ram's name written in devotional heart""large devotional eyes filled with tears of Ram-bhakti""divine orange-saffron aura glow surrounding body""sacred janeu thread, white dhoti",
    ],
    clothingRules:
  ...
  },
  {
    ...
    visualReferences: [
      "fair golden skin — slightly lighter than Ram, warm golden tone""fierce younger brother's alert protective expression""strong warrior build, ever-vigilant eyes scanning surroundings""bow always strung and ready, quiver full of arrows on back""sacred janeu thread across chest",
    ],
    clothingRules:
  ...
  },
  {
    ...
    visualReferences: [
      "imposing dark-gold complexion — powerful dark skin with golden divine sheen""ten heads suggested by golden crown cluster — show 1-2 heads with shadows suggesting more, never cartoon multi-head""massive powerful warrior form radiating supreme Lanka power""golden armour with jewelled chest plate — Lanka's magnificence""shown from profile or slightly behind — never full frontal face (adds mystery and menace)""dark red aura of rakshasa power and pride",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "elderly yet majestic king in his 60s — white mustache and beard, noble aged face""deep sorrowful wise eyes filled with royal dignity and hidden grief""bare chest with sacred janeu thread, strong aged Kshatriya body""heavy jewelled Kosala royal crown with large central ruby""multiple layers of thick gold necklaces and heavy gold armlets""golden sceptre-staff held in right hand",
    ],
    clothingRules:
    ...
    restrictedChanges: [
      "always elderly — white beard and mustache, never shown young""expression always carries weight of sorrow or regal burden""crown always present — he is always the king""never shown without royal attire",
    ],
    samplePoses: [
      "seated on Ayodhya throne — majestic but with sadness in eyes""embracing Ram before exile — overcome with grief""lying on royal bed dying of grief — torch-lit chamber""conducting Ram's coronation yagna — fire and priests around",
    ],
    referencePrompt: "King Dasharath the great emperor of Ayodhya full body portrait, elderly yet majestic Kshatriya king in his 60s, noble aged face with full white mustache and white beard, deep sorrowful wise eyes filled with royal dignity, wearing magnificent deep burgundy-red silk royal dhoti with heavy gold zari border, elaborate jewelled Kosala royal crown with large central ruby and peacock feather, multiple layers of thick gold necklaces with large gems and heavy gold armlets on both arms, bare chest with sacred janeu thread, holding golden sceptre-staff in right hand, seated on ornate Ayodhya throne of carved sandstone, royal throne room background with tall stone pillars golden lamps and red silk curtains, warm amber royal court lighting, expression of majestic sorrow and regal burden, ancient Treta Yuga, cinematic 8K ultra-detailed, no modern elements, no western clothing, no anime, no cartoon",
    preferredModel: "kling-3.0",
    universeId: "A",
  },

  {
    ...
    visualReferences: [
      "dignified regal queen in her 50s — luminous warm golden complexion""large gentle lotus-shaped eyes with serene maternal compassion""dark hair with silver streaks in braided crown adorned with jasmine""maang tikka, pearl necklace, delicate gold bangles""hands often in namaskara mudra or holding oil lamp in puja""cream-ivory silk sari with wide gold zari border",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "beautiful proud queen in her 40s — warm golden complexion, sharp intelligent eyes""expression of fierce royal resolve — determined, not soft""ornate gold crown, heavy gold necklaces with large rubies""rich deep saffron-orange Banarasi silk sari with wide gold border""gold bangles on both arms, large gold earrings""standing upright with posture of royal command",
    ],
    clothingRules:
    ...
    restrictedChanges: [
      "always saffron or orange sari — never red (that is Sita's) or white (mourning)""expression always determined and proud — rarely soft""crown always present — she asserts her queenly status""shown with Manthara nearby in political scenes",
    ],
    samplePoses: [
      "in kopa bhavan — seated on floor in proud grief demanding her boons""confronting Dasharath — standing firm, eyes cold with resolve""in regret — alone, realising the destruction she caused""as warrior queen in flashback — on chariot helping Dasharath in battle",
    ],
...

  {
    ...
    visualReferences: [
      "young man in mid-20s, fair golden complexion similar to Lakshman""face etched with deep grief and devotion, haunted eyes""wearing rough bark-cloth or simple white ascetic dhoti — no royal robes""no crown, no ornaments — only sacred janeu thread""carrying Ram's golden padukas sandals reverently in both palms""thin body from fasting and penance during 14-year wait",
    ],
    clothingRules:
    ...
    restrictedChanges: [
      "never in royal robes or crown — he renounced them""always carrying or near Ram's golden padukas""expression always grief and devotion — never joy until Ram returns""thin ascetic body — shows 14 years of self-imposed penance",
    ],
    samplePoses: [
      "kneeling at Nandigram — holding Ram's padukas above his head""seated in hermitage hut — ruling in Ram's name as regent""pleading with Ram at Chitrakoot — begging him to return""overjoyed reunion with Ram at Ayodhya — tears streaming down face",
    ],
    referencePrompt: "Prince Bharat the devoted brother of Ram full body portrait in ascetic renunciation, young man in mid-20s, fair warm golden complexion similar to Lakshman, deeply sorrowful eyes etched with guilt devotion and grief, lean body from 14 years of fasting and penance, wearing rough simple bark-cloth brown dhoti like an ascetic forest hermit — NOT royal silk, bare chest with only sacred janeu thread — no gold necklaces no crown no ornaments, carrying Lord Ram's sacred golden padukas sandals reverently held aloft in both palms with utmost care and devotion, kneeling on bare forest ground of Nandigram outside Ayodhya, simple forest hermitage hut background with small sacred fire and forest trees, expression of profound grief self-punishment and unwavering devotion — he believes himself responsible for Ram's exile, ancient Treta Yuga, cinematic 8K ultra-detailed, ASCETIC APPEARANCE no royal clothing, no modern elements, no western clothing, no anime, no cartoon",
    preferredModel: "kling-3.0",
    universeId: "A",
  },

  {
    ...
    visualReferences: [
      "lean dark-complexioned rakshasa with noble dignified features unlike other demons""Vishnu tilak on forehead — white vertical lines with red dot (his divine allegiance)""rudraksha mala around neck, simple sacred thread""wearing white cotton dhoti and saffron uttariya shawl — NOT gold armour""holding small brass kamandal and lotus flower""half standing in divine light, half in Lanka's shadow — the inner conflict resolved",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "youngest brother in early 20s, fair warm complexion close to Lakshman's""bright alert eyes, eager youthful expression — the youngest, always energetic""always positioned beside or slightly behind Bharat""bow strung and quiver on back, simpler crown than Ram's""sacred janeu thread across bare chest""saffron-yellow silk dhoti with thin gold border",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "powerful sage in his 60s — lean muscular body from years of severe tapas""tall imposing frame, matted brown-grey hair piled high in jata mukut""sacred white ash vibhuti marks on forehead and arms""piercing eyes like burning coals — spiritual warrior energy""saffron orange cotton dhoti only, no upper garment""holding tall kamandal and kush grass; divine fire tapas aura in orange-gold",
    ],
    clothingRules:
    ...
    restrictedChanges: [
      "always bare-chested — no upper garment like other sages""matted jata hair — never loose or neatly combed""expression always fierce and commanding — never gentle""ash marks always on forehead — his tapas mark",
    ],
    samplePoses: [
      "striding forward with Ram and Lakshman flanking him — purpose-filled march""arms raised calling divine astra — teaching Ram celestial weapons""standing before Dasharath demanding Ram — uncompromising""seated in ashram — fire kund blazing during yajna",
    ],
...

  {
    ...
    visualReferences: [
      "monkey face with simian features — protruding muzzle, flat primate nose""golden-tawny brown monkey fur, stocky powerful vanara king build""royal crown of Kishkindha — more ornate than ordinary vanaras""gold necklace and armlets — kingly vanara bearing""seated on stone throne or standing with royal authority""mace or sword — king's weapon, not just boulders like soldiers",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "massive magnificent eagle with huge wing span — golden-brown body""white feathered regal head of an elder eagle, sharp intelligent divine eyes""powerful curved beak and sharp talons gripping stone or earth""battle wounds on one wing from fighting Ravan — blood on wing tip""standing with supreme courage and dignity despite mortal wounds""divine golden light around him — sacred dying warrior",
    ],
    clothingRules:
    ...
    restrictedChanges: [
      "always eagle form — never human or hybrid""always showing battle wounds — that is his defining moment""large ancient eagle — not a small bird, massive divine creature""expression of sacrifice and dignity — never fear",
    ],
    samplePoses: [
      "lying on forest ground — dying, neck raised to give Ram his last message""wings spread in battle — fighting Ravan's chariot mid-air""Ram cradling dying Jatayu — Ram weeping over his fallen friend""standing wounded but proud — refusing to fall until Ram arrives",
    ],
    referencePrompt: "Jatayu the divine eagle son of Aruna full body portrait, massive magnificent ancient eagle the size of a small hill, golden-brown eagle body with large powerful wings, noble white-feathered elder eagle head with sharp intelligent divine eyes filled with sacrifice and courage, heavy curved golden beak, powerful scaled talons gripping the Panchavati forest ground, battle wounds clearly visible on right wing — feathers torn and blood on wing tip from fighting Ravan single-handedly to protect Sita, lying with one wing spread and neck raised upright toward Ram with last remaining strength, body radiating divine golden light of a sacred dying warrior, dense ancient Panchavati forest background with large trees and dramatic shafts of golden afternoon light piercing through canopy, expression of supreme selfless sacrifice and dignity — no fear only devotion, ancient Treta Yuga, cinematic 8K ultra-detailed, GIANT EAGLE bird form NOT human, battle wounds visible, no modern elements, no anime, no cartoon",
    preferredModel: "kling-3.0",
    universeId: "A",
  },

  {
    ...
    visualReferences: [
      "very old tribal woman with deeply wrinkled dark complexion and white hair""small hunched frail frame — decades of forest penance""simple rough earth-toned brown sari of coarse cloth, barefoot""glass bead necklace, red bangles — simple tribal ornaments""leaf plate of forest berries before her — each one tasted with pure love""tears of joy streaming down aged face — Ram has finally come",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "young powerful vanara in prime — MONKEY face with fierce proud simian features""reddish-gold fur covering athletic muscular body — younger and leaner than Sugriva""wearing his father Vali's golden armlets on both upper arms — tribute to Vali""saffron-orange silk dhoti, no royal crown — a prince not yet a king""expression of fierce young warrior pride — daring anyone to challenge him""foot planted firmly on ground — the famous Sabha scene in Lanka",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "absolutely massive giant demon — dwarfs everything around him""dark mahogany-brown rocky rough skin texture, enormous bald head""small heavy-lidded eyes just waking from long sleep — still groggy""massive arms like tree trunks, barrel chest wide as a house""simple enormous dark red rough cloth around giant waist""colossal spiked iron club or uprooted tree as weapon",
    ],
    clothingRules:
    ...
    restrictedChanges: [
      "always enormous — soldiers and buildings must look tiny beside him""always half-awake — heavy-lidded sleepy eyes even in battle""no crown, no armour — the giant needs none""dark rough rocky skin — not smooth, textured like stone",
    ],
    samplePoses: [
      "rising from sleep — enormous body filling the frame, vanaras fleeing below""striding into battle — foot crushing the ground, army parting before him""swatting vanaras like flies — horrifying scale difference""mortally wounded but still standing — the tragic giant refuses to fall",
    ],
...

  {
    ...
    visualReferences: [
      "dark indigo-black complexion with supernatural glow — young demon prince""fierce intense eyes radiating dark demonic power and supreme confidence""magnificent black and gold Lanka battle armour with supernatural engravings""large ornate black crown with gold trim — Lanka's crown prince""crackling dark Brahmastra energy weapon in one hand — black-purple lightning""dark purple-black invincibility aura surrounding entire body",
    ],
    clothingRules:
    ...
    restrictedChanges: [
      "always in full battle armour — never shown unarmed or unarmoured""always young — not middle-aged like Ravan, he is the son""dark indigo-black skin — darker than Ravan""always dark energy aura — his supernatural power is his defining trait",
    ],
    samplePoses: [
      "firing Nagastra serpent weapon — coils of dark energy from drawn bow""invisible attack — dark form barely seen through supernatural concealment""standing over unconscious Lakshman — moment of apparent victory""final battle with Lakshman — both unleashing divine weapons",
    ],
...

  {
    ...
    visualReferences: [
      "extraordinarily beautiful queen with luminous warm complexion""large sorrowful compassionate eyes — she knows tragedy is coming""elaborate crown of gold and deep rubies in dark hair""rich deep purple-crimson Banarasi silk sari with very wide gold border""heavy layered gold necklaces with rubies — Lanka's queen wears its wealth""one hand on heart — her grief and love expressed in gesture",
    ],
    clothingRules:
    ...
    restrictedChanges: [
      "always beautiful and dignified — NOT a demon-faced woman""always in grief — she knows what is coming""purple-crimson sari — her distinct colour from Sita's red""heavy ruby-gold ornaments — Lanka's queen wears its wealth",
    ],
    samplePoses: [
      "pleading with Ravan — hands clasped, tears in eyes""standing alone on Lanka's highest tower — watching the battle""weeping over Ravan's body after his fall""seated on Lanka throne beside Ravan — regal but sorrowful",
    ],
    referencePrompt: "Queen Mandodari the devoted queen of Lanka full body portrait, extraordinarily beautiful regal woman with luminous warm golden complexion, large dark sorrowful compassionate eyes carrying the weight of knowing tragedy is inevitable, thick lustrous dark black hair adorned with large ornate crown of heavy gold and deep red rubies, wearing rich deep purple-crimson pure silk Banarasi sari — the colour distinct from Sita's red, with very wide heavy gold zari woven border and gold pallu draped elegantly, multiple heavy layered gold necklaces with large ruby pendants and emerald accents, thick gold bangles, large gold drop earrings with rubies, one hand pressed gently on her heart in a gesture of grief and devotion, standing on a high terrace of Lanka palace with dark obsidian stone walls and golden torches, vast ocean visible behind, expression of profound noble grief — beautiful but heartbroken, NOT demonic NOT monstrous but regal and tragic, ancient Treta Yuga, cinematic 8K ultra-detailed, BEAUTIFUL DIGNIFIED QUEEN not demon, no modern elements, no anime, no cartoon",
    preferredModel: "kling-3.0",
    universeId: "A",
  },

  {
    ...
    visualReferences: [
      "elderly dark-complexioned woman with pronounced hunchback clearly visible""narrow calculating eyes with scheming bitter expression and cunning smile""wrinkled face, wiry grey hair pulled tightly back""simple dark indigo-blue servant sari — minimal border""walking stick in one hand, other hand gesturing conspiratorially""dramatic shadow cast across her hunched form",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "ancient sage in his 70s — long white flowing hair and white beard""serene face radiating infinite wisdom and compassion""pure white dhoti, sacred janeu thread, rudraksha mala""holding rudraksha mala in right hand, brass kamandal in left""seated on tiger skin in meditation or standing in blessing pose""divine white-silver light aura of highest brahmarishi energy",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "massive bear form standing upright — large round bear head, dark brown-black fur""white chest fur patch — distinguishing elder bear marking""wise ancient eyes filled with deep cosmic knowledge""sacred janeu thread across broad bear chest""simple white dhoti around bear waist""heavy gnarled wooden staff or stone club in one hand",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "dark olive-brown complexioned demon woman — wild fierce features""large clawed fingers and toes, wild tangled black hair""wearing rough dark red woven rakshasi sari with tribal bone ornaments""large silver nose ring, thick heavy silver bangles""forest flowers and leaves woven into tangled hair""eyes gleaming with fierce desire and menace",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "in golden deer form: impossibly beautiful magical deer, coat of pure shimmering gold""silver spots catching supernatural light across golden flanks""large supernatural eyes with hidden rakshasa intelligence behind them""golden hooves and delicate golden antlers with gem-like tips""magical unnatural shimmer and glow — too perfect to be real""standing in dappled forest sunlight that makes the gold body blaze",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "gentle queen in her 40s — soft warm complexion, kind compassionate eyes""dark hair with small yellow flowers in a simple braid""soft green-yellow silk sari with thin gold border — gentle colours""simple gold ornaments — small earrings and thin delicate bangles""delicate refined manner, seated in peaceful garden setting""holding small brass oil lamp — her ritual of daily prayer",
    ],
    clothingRules:
    ...
    restrictedChanges: [
      "always soft gentle colours — never orange like Kaikeyi or red like Sita""always gentle compassionate expression — never fierce or proud""minimal ornaments — the least adorned of the three queens""small flowers in hair — her gentle signature",
    ],
    samplePoses: [
      "sending Lakshman to forest with Ram — blessing him with both hands""seated in Ayodhya garden — waiting, praying, at peace""consoling Kaushalya — gentle arm around her grieving sister-queen""morning puja by garden pond — peaceful devotion",
    ],
    referencePrompt: "Queen Sumitra third queen of Ayodhya mother of Lakshman and Shatrughan full body portrait, gentle beautiful queen in her mid-40s, soft warm golden complexion radiating quiet inner peace, large kind compassionate dark eyes filled with gentle sorrow and spiritual acceptance, dark hair in simple neat braid adorned with small fresh yellow champa flowers, wearing soft sage-green pure silk sari with thin delicate gold border — gentle quiet colours not vibrant, simple pearl drop earrings and thin delicate gold bangles — minimal ornaments the least adorned of the queens, holding a small lit brass diya oil lamp in both cupped palms as a quiet daily offering, seated on carved stone bench in a peaceful Ayodhya palace garden with a lotus pond and flowering trees behind her, soft afternoon golden light filtering through garden leaves, expression of serene quiet spiritual strength and gentle maternal love — accepts dharma even when it takes her sons, ancient Treta Yuga, cinematic 8K ultra-detailed, GENTLE SOFT COLOURS not vibrant, MINIMAL ornaments, no modern elements, no anime, no cartoon",
    preferredModel: "kling-3.0",
    universeId: "A",
  },
...

  {
    ...
    visualReferences: [
      "massive powerfully built vanara with jet-black fur — darker than all other vanaras""MONKEY face with dominant fierce primate features — larger jaw, stronger brow""golden divine boon necklace glowing around his neck — his source of power""ornate Kishkindha gold crown — he is always the king""enormous muscular arms, commanding intimidating stance""dark golden aura of the divine boon surrounding his body",
    ],
    clothingRules:
    ...
    restrictedChanges: [
      "always monkey face — never human""jet-black fur — much darker than Sugriva's golden-tawny""golden necklace always glowing — it is the source of his power""always the most physically imposing vanara in any scene",
    ],
    samplePoses: [
      "standing on Kishkindha mountain — arms spread, absolute ruler""in battle with Sugriva — overpowering him effortlessly""struck by Ram's arrow — questioning Ram with dying dignity""seated on throne — every inch the unquestionable king",
    ],
    referencePrompt: "Vali the vanara king of Kishkindha full body portrait, supremely powerful massive vanara with jet-black fur covering an enormous muscular body — the most physically imposing vanara alive, MONKEY face with dominant fierce primate features — larger jaw stronger brow ridge deeper set eyes than other vanaras, wearing ornate Kishkindha royal gold crown more elaborate and heavy than Sugriva's, glowing divine golden necklace at throat radiating supernatural power — this is the source of his boon that halves all opponents' strength, rich deep gold silk dhoti with heavy border, thick gold armlets, massive clenched fists the size of boulders, standing in commanding stance atop Kishkindha mountain with the forest kingdom visible below him, dark storm clouds gathering behind him adding to his menacing power, dark golden aura of divine boon surrounding his entire body, expression of absolute supreme power and pride — this is a king who has never known defeat, ancient Treta Yuga, cinematic 8K ultra-detailed, JET BLACK FUR most imposing vanara, GLOWING NECKLACE visible, MONKEY face dominant, no modern elements, no anime, no cartoon",
    preferredModel: "kling-3.0",
    universeId: "A",
  },

  {
    ...
    visualReferences: [
      "beautiful young princess in her early 20s — luminous complexion""large dark eyes carrying deep longing and quiet sacrifice — haunted but dignified""dark hair in simple braid with minimal adornment — partially in penance""pale moonlight-silver or soft white silk sari with thin gold border""minimal gold ornaments — small earrings, thin bangles of a woman in partial vow""seated by palace window looking out — the eternal wait",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "short stout powerfully built sage — compact body from intense tapas""dark warm complexion, round face with bushy thick eyebrows""eyes like burning coals — fierce concentrated divine fire""matted dark-brown jata hair piled high despite short stature""saffron dhoti, sacred ash marks on forehead and arms""holding a golden bow or sacred text — giving Ram divine weapons",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "MONKEY face with focused intelligent craftsman expression""brown-golden fur, medium build — more wiry than warrior vanaras""carrying measuring rope in one hand and a flat rock in other""simple work dhoti — practical not royal""ocean behind him with rocks visibly floating on water — Ram Setu""thousands of vanaras working in background",
    ],
    clothingRules:
...

  {
    ...
    visualReferences: [
      "graceful female vanara with golden-tawny fur — lighter than Vali's black""female MONKEY face with sorrowful dignified features and large expressive eyes""white silk mourning dhoti with thin gold border — the colour of vanara widowhood""simple gold bangles and necklace of a widowed queen""one hand resting on Vali's memorial stone or chest""expression of profound grief and quiet dignified acceptance",
    ],
    clothingRules:
