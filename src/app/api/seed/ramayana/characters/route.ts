...
const CHARACTERS = [
  ...
  },
  {
    ...
    referencePrompt: "Photorealistic divine portrait of Lord Hanuman seated in full padmasana cross-legged meditation pose, silver-grey fur covering his massive powerfully muscular body — the grey of a Hanuman langur monkey NOT orange NOT white albino, reddish-pink monkey face with grey beard fur around jaw and chin, eyes fully CLOSED in deep peaceful devotion, subtle serene smile, red tilak on forehead, large elaborate ornate GOLD MUKUT crown on head with detailed temple carvings and red gem at centre, elaborate GOLD SHOULDER PAULDRONS armour pieces on both shoulders with intricate engravings, dark brown rudraksha mala beads draped across chest, gold chest pendant, both massive hands pressed together in anjali namaskara mudra at chest, white and magenta-pink dhoti with gold zari border draped in cross-legged lap, tiny spotted golden fawn deer standing at his feet to show enormous divine scale, large misty tropical forest waterfall cascading behind him filling the background, lush green tropical forest trees, moss-covered wet boulders, cool atmospheric mist, photoreal individual fur strand texture, genuine gold metal detail, Gemini Imagen quality photorealistic, no fire no mace, no orange fur, no cartoon no anime",
    preferredModel: "kling-3.0",
    universeId: "A",
  },
  {
