...
const CHARACTERS = [
  ...
  },
  {
    ...
    referencePrompt: "Lord Hanuman divine vanara devotee of Ram, full body portrait standing heroically, powerful muscular warm saffron-brown simian body with divine radiance, broad chest, strong arms, sacred white dhoti, golden janeu sacred thread across chest, golden gada mace held firmly in right hand, long tail curving upward behind him with orange flame tip, large expressive eyes filled with deep devotion and tears of bhakti, divine saffron-orange aura glow surrounding whole body, ancient stone temple background with warm torchlight and marigold flowers, Raja Ravi Varma divine Indian oil painting style, cinematic 8K ultra-detailed, NOT human face — simian vanara face with divine expression, no cartoon, no anime, no modern elements",
    preferredModel: "kling-3.0",
    universeId: "A",
  },
  {
