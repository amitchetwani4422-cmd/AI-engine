...
const CHARACTERS = [
  ...
  },
  {
    ...
    referencePrompt: "Goddess Sita avatar of Lakshmi, full body portrait standing gracefully, golden-wheat luminous glowing complexion, large gentle divine eyes, serene compassionate expression, dark hair in single braid adorned with jasmine flowers and gold pins, rich deep red Banarasi silk sari with wide gold zari border and golden pallu draped over shoulder, divine gold maang tikka on forehead, gold necklace bangles and earrings, delicate bare feet with red alta, soft lotus flowers at feet, ancient Indian palace interior with arched stone windows and warm golden light, Raja Ravi Varma divine Indian oil painting style, cinematic 8K ultra-detailed, no modern elements, no anime, no cartoon",
    preferredModel: "kling-3.0",
    universeId: "A",
  },
  {
    ...
    referencePrompt: "Hanuman the vanara monkey deity, full body portrait, MONKEY face: protruding simian muzzle, flat primate nose, wide monkey jaw, primate brow ridge, monkey ears — NOT a human face, young powerfully muscular body covered in short warm saffron-orange monkey fur, extremely long thick monkey tail rising prominently behind curling upward with bright orange flame at tip, simple white cotton dhoti around waist, heavy golden gada cylindrical club-shaped mace gripped firmly in right hand — NOT a bow NOT a trident, sacred janeu thread across broad chest, large tearful devotional eyes looking upward, divine saffron-orange radiant aura, ancient stone Nagara temple background warm oil-lamp glow, Raja Ravi Varma divine Indian oil painting style Treta Yuga cinematic 8K ultra-detailed, young and powerful NOT old NOT bearded",
    preferredModel: "kling-3.0",
    universeId: "A",
  },
  {
    ...
    referencePrompt: "Prince Lakshman devoted brother of Ram, full body portrait in warrior stance, fair warm golden complexion slightly lighter than Ram, strong athletic Kshatriya warrior build, fierce alert protective eyes scanning for threats, strung bow held ready in left hand, full quiver of arrows on back, simpler jewelled crown than Ram, saffron-yellow silk dhoti with gold border, sacred janeu thread across chest, bare feet, ancient forest clearing at dusk with golden light filtering through trees, Raja Ravi Varma divine Indian oil painting style, cinematic 8K ultra-detailed, no modern elements, no anime, no cartoon",
    preferredModel: "kling-3.0",
    universeId: "A",
  },
  {
    ...
    referencePrompt: "King Ravan demon king of Lanka, full body portrait from dramatic 3/4 profile angle, imposing dark-gold complexion powerfully built rakshasa form, magnificent golden armour with jewelled chest plate and shoulder guards, cluster of ornate jewelled crowns stacked on head suggesting ten crowns without showing multiple faces, heavy gold ornaments — thick armlets rings and earrings dripping with Lanka's wealth, rich dark crimson silk royal dhoti, one hand raised with a divine astra weapon crackling with dark energy, dark crimson and storm-purple aura of supreme power and menace, grand Lanka palace throne room background with golden pillars and dark shadows, Raja Ravi Varma divine Indian oil painting style, cinematic 8K ultra-detailed, single face visible in profile, no cartoon, no anime, no modern elements",
    preferredModel: "kling-3.0",
    universeId: "A",
  },
];
