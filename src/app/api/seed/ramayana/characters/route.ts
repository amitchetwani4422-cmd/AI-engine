...
const CHARACTERS = [
  ...
  },
  {
    ...
    referencePrompt: "Photorealistic VFX creature portrait, hyper-realistic divine vanara Hanuman, Hollywood blockbuster photoreal CGI like Planet of the Apes — noble and powerful NOT beast-like NOT orangutan, saffron-orange fur covering tall powerfully muscular upright body, noble intelligent primate face: clear simian muzzle, flat wide nose, strong jaw, DEVOTED UPWARD-GAZING eyes filled with bhakti — NOT confused NOT sad, chin raised with noble divine warrior dignity, ABSOLUTELY NO FIRE ON HEAD — the head has plain saffron-orange fur only, long thick monkey tail curving UP behind him with small orange flame ONLY at the very tip of the tail — nowhere else, heavy THICK CYLINDRICAL golden gada mace — wide heavy club shape like a proper Indian gada, NOT a thin rod — gripped firmly in right fist, sacred white janeu thread across broad chest, plain white cotton dhoti around waist, gold bangles, standing upright tall in ancient carved stone temple hall, warm natural oil-lamp amber light from below, individual fur strand texture, no fire on head no flames anywhere except tail tip, no cartoon no anime, NOBLE DIVINE WARRIOR bearing",
    preferredModel: "kling-3.0",
    universeId: "A",
  },
  {
